...
int main(){
    ...
    auto duration1 = duration_cast<microseconds>(stop1 - start1); // calculate duration
    if (ds_option == 1)
        cout << "Tree building execution time: " << duration1.count() << " microseconds\n" << endl;
    else
        cout << "Map building execution time: " << duration1.count() << " microseconds\n" << endl;
    ...
    cout << "11. CANCEL\n" << endl; // if user input 11 program stops
    cin >> option;
    ...
    while (option != 11){
        ...
        auto stop2 = high_resolution_clock::now(); // timer end
        auto duration2 = duration_cast<microseconds>(stop2 - start2); // calculate duration

        // print execution time
        if (ds_option == 1)
            cout << "Tree traversal execution time: " << duration2.count() << " microseconds\n" << endl;
        else
            cout << "Map traversal execution time: " << duration2.count() << " microseconds\n" << endl;
